...
This map proportionates an idea of what has been done in this project, as we first calibrate the hindcast node in green  with those black satellite measures. After data, the validation with the buoy in blue is performed.
...
- Satellite: IMOS satellite data has been used and it can be downloaded from the IMOS website. https://www.gebco.net/
